...
env.config();
app.use(cors({origin:['http://localhost:5173','https://admin-stile-12333.vercel.app','https://stile-backend-gnqp.vercel.app','https://stile-12333.vercel.app'],credentials:true}));
