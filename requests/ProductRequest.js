...
env.config();
app.use(cors({origin:['http://localhost:5173','https://stile-backend-gnqp.vercel.app','https://stile-frontend-9jne.vercel.app','https://stile-12333.vercel.app'],credentials:true}));
